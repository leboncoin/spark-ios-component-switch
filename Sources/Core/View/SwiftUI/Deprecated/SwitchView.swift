...
@available(*, deprecated, message: "Use SparkToggle instead !")
public struct SwitchView: View {
    ...
    @ObservedObject private var viewModel: SwitchViewModelDeprecated
...
private extension Image {
    ...
    func applyStyle(
        isForOnImage: Bool,
        viewModel: SwitchViewModelDeprecated
    ) -> some View {
        if isForOnImage {
    ...
    func applyImageStyle(viewModel: SwitchViewModelDeprecated) -> some View {
        self.resizable()
