//
//  SwitchViewModelDeprecated.swift
//  SparkSwitch
//
...
final class SwitchViewModelDeprecated: ObservableObject {
    ...
    private let dependencies: any SwitchViewModelDeprecatedDependenciesProtocol
    ...
    init(
        ...
        dependencies: any SwitchViewModelDeprecatedDependenciesProtocol = SwitchViewModelDeprecatedDependencies()
    ) {
        self.isOn = isOn
